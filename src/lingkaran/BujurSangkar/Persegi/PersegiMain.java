...
package lingkaran.BujurSangkar.Persegi;
...
public class PersegiMain {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Luas dari persegi dengan panjang="+objPersegi.panj+" dan lebar ="
                + " "+objPersegi.lebar+" adalah "+objPersegi.luas());
